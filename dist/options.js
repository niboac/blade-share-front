...
var blockSetting = {
  ...
  FANG_DI_DAI: {
    ...
    抵押: {
      抵押: {
        iconKey: 'icon-zhaopian',
        imgUrls: [{ label: '抵押证', group: 'diya' }, { label: '抵押受理通知单/收据', group: 'shouju' }]
      }
    }
