...
var orderDetailLabel = exports.orderDetailLabel = Object.assign(clone(orderLabel), clone(applicantLabel));
var orderDetailDefault = exports.orderDetailDefault = Object.assign(clone(orderDefault), clone(applicantDefault));

// export const fastOrderLabel = Object.assign(clone(orderLabel), clone(applicantLabel))

var fastOrderLabel = exports.fastOrderLabel = clone(orderLabel);
fastOrderLabel.applicant = clone(applicantLabel);
var fastOrderDefault = exports.fastOrderDefault = clone(orderDefault);
fastOrderDefault.applicant = clone(applicantDefault);
var fastOrder_hhLabel = exports.fastOrder_hhLabel = clone(fastOrderLabel);
var fastOrder_hhDefault = exports.fastOrder_hhDefault = clone(fastOrderDefault);
