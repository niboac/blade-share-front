  ...
  FANG_DI_DAI: {
    ...
    下户: Object.assign(xiahuInCommon, {
      ...
      上传下户照片: {
        ...
        imgUrls: [{ label: '小区', group: 'xiaoqu' }, { label: '房屋外立面', group: 'wailimian' }, { label: '门牌号', group: 'ruhukou' }, { label: '客厅', group: 'keting' }, { label: '厨房', group: 'chufang', imageRequire: '每室不少于一张' }, { label: '卧室', group: 'woshi' }, { label: '卫生间', group: 'weishengjian' }, { label: '餐厅', group: 'canting' }, { label: '电梯', group: 'dianti' }]
      }
    }),
    合同: {
      公证: {
